...
public class Scoreboard implements ScoreboardManager {
    ...
    public Scoreboard(Player player) {
        ...
        if(OnePieceUHC.getInstance().scoreboard.containsKey(player)) return;
        ...
        OnePieceUHC.getInstance().scoreboard.put(player, this);
    }
    ...
    public void refresh() {
        //******************************************************************************************
        // Timer Général
        String time = new SimpleDateFormat("mm:ss").format(OnePieceUHC.getInstance().global_timer * 1000);
        int timeri = OnePieceUHC.getInstance().global_timer;
        ...
        //******************************************************************************************
        // Rôles
        String role = new SimpleDateFormat("mm:ss").format(OnePieceUHC.getInstance().role_time_s * 1000);
        int rolesi = OnePieceUHC.getInstance().role_time_s;
        ...
        //******************************************************************************************
        // PVP
        String pvp = new SimpleDateFormat("mm:ss").format(OnePieceUHC.getInstance().pvp_time_s * 1000);
        int pvpi = OnePieceUHC.getInstance().pvp_time*60;
        ...
        //******************************************************************************************
        // Bordure
        String bordure = new SimpleDateFormat("mm:ss").format(OnePieceUHC.getInstance().border_time_s * 1000);
        int bordurei = OnePieceUHC.getInstance().border_time_s;
        ...
        for(String line: scoreboard.getEntries()) {
            if(line.contains("§6 Timer :")) {
                ...
                scoreboard.resetScores(line);
                if(OnePieceUHC.getInstance().role_time_s <= 0)
                ...
                scoreboard.resetScores(line);
                if(OnePieceUHC.getInstance().pvp_time_s <= 0)
                ...
                scoreboard.resetScores(line);
                if(OnePieceUHC.getInstance().border_time_s <= 0)
                ...
                scoreboard.resetScores(line);
                int size = (int) (OnePieceUHC.getInstance().border.getSize())/2;
                if(size==99) size++;
                objective.getScore("§c  Taille : " + size + "/" + size).setScore(4);
            }
            else if(line.contains(" §e§m-§r§e>")) {
                scoreboard.resetScores(line);
                int ingame = OnePieceUHC.getInstance().InGame.size();
                int max = OnePieceUHC.getInstance().maxPlayer;
